...
class Image(RSSBaseModel):
    ...
    link: str = None
    "The URL of the site, when the channel is rendered, the image is a link to the site. (Note, in practice the " \
    "image <title> and <link> should have the same value as the channel's <title> and <link>."  # noqa
